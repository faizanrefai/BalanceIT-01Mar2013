...
- (NSString*) contents {
	return @"A game brought to you by Revolution Games, Inc.\n\nConcept and Design\nBenjamin Anderson\nWilliam McKown\n\nProgramming\nMr. Chang\nMr. Ryu\n\nGraphics\nBenjamin Anderson\nMr. Jon\n\nMusic and Sounds\nTampa Digital\n\nLevel Design\nBenjamin Anderson";
}
...
- (void) initContents {
	...
	ctrlContents.textAlignment = UITextAlignmentCenter;
	ctrlContents.font = [UIFont fontWithName:@"Courier" size:14 * RATE_HEIGHT];
